...
<a 
  href={url}
  class="border-b border-gray-200 py-4 flex flex-col outer-padding"
>
  ...
  <div class="flex items-center flex-wrap gap-x-4 gap-y-2">
    <div class="px-2 py-0.5 bg-gray-200 text-xs font-bold text-gray-600 uppercase">
      {item.jadwal.tipe}
    </div>
    <div class="px-2 py-0.5 bg-gray-200 text-xs font-bold text-gray-600 uppercase">
    ...
    {#if item.unit_kerja}
      <div class="px-2 py-0.5 bg-gray-200 text-xs font-bold text-gray-600">
        unit kerja: { item.unit_kerja.nama }
      </div>
    {/if}
    {#each item.shifts as shift}
      {#if shift.id}
        <div class="px-2 py-0.5 bg-gray-200 text-xs font-bold text-gray-600 flex items-center">
